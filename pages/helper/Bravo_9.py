...
def banco1():
    ...
    with clms28[1]:
        st.markdown("<a href='https://edpuzzle.com/media/661d4fbc6190b34cdf780418' target='_blank'><img style='float: left;' src='https://raw.githubusercontent.com/celenaaponce/sandbox/main/images/puzzle.png' width='100' height='100'/></a>", unsafe_allow_html=True)     
        st.markdown("<a href='https://edpuzzle.com/media/661d5a8f607cee61aa154c91' target='_blank'><img style='float: left;' src='https://raw.githubusercontent.com/celenaaponce/sandbox/main/images/puzzle.png' width='100' height='100'/></a>", unsafe_allow_html=True)     
