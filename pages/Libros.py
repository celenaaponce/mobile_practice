...
with outer_col[0]:
    ...
    st.markdown("<a href='https://youtu.be/X-DT_SDXxO4' target='_blank'><img width='300' src='https://raw.githubusercontent.com/celenaaponce/mobile_practice/main/images/lindobebecito.png'></a>", unsafe_allow_html=True)
