...
def ASL1_sidebar():
            ...
            st.sidebar.page_link("pages/Bravo_3.py", label="Dónde está el control?")
...
def ASL3_sidebar():
            ...
            st.sidebar.page_link("pages/Bravo_9.py", label="Banco")
...
def ASLEnCasa_sidebar():
            ...
            st.sidebar.page_link("pages/ASLAtHome_c2.py", label="Hora del Baño")
            st.sidebar.page_link("pages/ASLAtHome_c3.py", label="Hora del Cambio de Pañal")
...
def MenuButtons(user_roles = ''):
    ...
    elif user_roles == 'ASL3':
            ASL3_sidebar()
    elif user_roles == 'ASLEnCasa':
                ASLEnCasa_sidebar()
